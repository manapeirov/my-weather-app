...
const SingleCityWeatherPage = ({ match, weatherData, loading, hasErrors, dispatch}) => {
    ...
    const renderSingleCityWeather = () => {
        ...
        return <CityWeather key={weatherData.id} cityWeatherData={weatherData} singleCity/>
    }

    return (
        <div>
            {renderSingleCityWeather()}
        </div>
    )
}
...
// const SingleCityWeatherPage = ({ match, weatherData}) => {

//     const renderSingleCityWeather = () => {
//         return <CityWeather cityWeatherData={weatherData} />
//     }
//     return (
//         <div>
//             {renderSingleCityWeather()}
